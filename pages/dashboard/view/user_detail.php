...
<div class="row justify-content-center mt-4 ms-2">
	<div class="col-md-10 col-ms-8">
	   ...
	   <div class="d-flex justify-content-center animate__animated animate__fadeInDown">
		<img id="picture_modal" src="<?php echo $d_member['picture'];?>" alt="Member Avatar" class="rounded-circle z-depth-2" width="200px" height="200px" />
	   </div>
	   <div class="d-flex justify-content-center mb-0">
	       <h5 class="mt-2 text-center"><?php echo $d_member['name'];?></h5>
	   </div>
	   <div class="d-flex justify-content-center mb-0">
			<div class="col-md-6 col-ms-12 justify-content-center mt-2">
				<p>Username : <?php echo $d_member['username'];?></p> 
			</div>
			<div class="col-md-6 col-ms-12 justify-content-center mt-2">
			    <p>Access Type : <?php echo $d_member['level_akses'];?></p>
			</div>		   
	   </div>
	</div>
